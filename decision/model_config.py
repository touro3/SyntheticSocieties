...
Multi-Model Generalizability Study.
...
class ModelConfig:
    ...
    # Alignment-bias provenance tag: "instruct" (default RLHF-tuned),
...
def get_backend(config: ModelConfig):
    ...
    raise ValueError(
        f"Unknown backend_type: {config.backend_type!r}. Valid values: 'huggingface', 'openai', 'anthropic', 'gemini'."
    )
