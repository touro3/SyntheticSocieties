        ...
        for line in f:
            try:
                ...
                diag = {
                    ...
                    "has_social_context": "You have established several social ties" in p["prompt"]
                    or "central figure" in p["prompt"]
                    or "hop" in p["prompt"],
                    "has_trust_history": "Trust dictionary:" in p["prompt"]
                    or "You have previously cooperated" in p["prompt"],
...
def diagnose_experiment(experiment_id: str):
    ...
    for agent in sorted_agents:
        ...
        print(
            f"  Agent {agent:4s}: Work={counts['work'] / tot:.0%} Save={counts['save'] / tot:.0%} Coop={counts['cooperate'] / tot:.0%}"
        )
