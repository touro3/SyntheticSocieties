...
KS indistinguishability additions:
...
def _compute_participant_level(df: pd.DataFrame) -> pd.DataFrame:
    ...
    for participant_id, part in grouped:
        ...
        # Include pre-survey attributes if available
...
def main() -> None:
    ...
    # KS indistinguishability arguments
    parser.add_argument(
        "--sim-coop-a",
        default=None,
    ...
    # ── KS behavioral indistinguishability test + JSD ──────────
    ...
    if args.simulation_json and Path(args.simulation_json).exists():
        ...
        reference_payload = {
            ...
            "note": (
                "Primary comparison is two-sample KS test. "
