...
def main() -> None:
    ...
    output_csv = Path("analysis/tables/policy_comparison.csv")
    output_parquet = Path("analysis/tables/policy_comparison.parquet")
    ...
    print("Policy comparison table created.")
    print(summary)
