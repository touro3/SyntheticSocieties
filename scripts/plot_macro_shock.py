...
def main():
    ...
    axes[0].plot(
        trends_a["round_id"],
        trends_a["total_wealth"],
        label="Cond A (Ablated)",
        color="crimson",
        linewidth=2.5,
        linestyle="--",
    )
    axes[0].plot(
        trends_b["round_id"], trends_b["total_wealth"], label="Cond B (Grounded)", color="royalblue", linewidth=2.5
    )
    ...
    axes[1].plot(
        trends_b["round_id"], trends_b["cooperation_rate"], label="Cond B (Grounded)", color="royalblue", linewidth=2.5
    )
