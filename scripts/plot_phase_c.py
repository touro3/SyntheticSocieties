...
def main():
    ...
    parser.add_argument(
        "--data-dir", type=str, default="experiments/phase_c_comparison", help="Directory with parquet logs"
    )
    ...
    axes[0].plot(
        ...
        label="Condition B (Grounded ESS LLM)",
        color="royalblue",
        linewidth=2.5,
    )
