    ...
    for round_id in range(args.rounds):
        ...
        for agent, response in zip(agents, responses):
            ...
            if match:
                ...
                if "cooperate" in action_str:
                    act = "cooperate"
                elif "save" in action_str:
                    act = "save"
                else:
                    act = "work"
...
def main():
    ...
    run_simulation(
        "Condition A (Ablated LLM)",
        profiles,
        policy,
        backend,
        args,
        out_dir / "condition_a_adversarial.parquet",
        is_ablated=True,
    )
    run_simulation(
        "Condition B (Grounded BGF)",
        profiles,
        policy,
        backend,
        args,
        out_dir / "condition_b_adversarial.parquet",
        is_ablated=False,
    )
