#!/usr/bin/env python3
"""Run cross-cultural ESS validation experiments.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Cross-Cultural ESS Validation")
    parser.add_argument(
        "--dry-run",
        action="store_true",
    ...
    print("=" * 60)
    print("  Cross-Cultural ESS Validation")
