...
def main():
    ...
    run_simulation("Condition A (Ablated - Shocked)", profiles, ParallelPolicyShock(backend), backend, args, out_dir / "condition_a_shock.parquet", is_ablated=True)
    run_simulation("Condition B (Grounded - Shocked)", profiles, ParallelPolicyShock(backend), backend, args, out_dir / "condition_b_shock.parquet", is_ablated=False)
